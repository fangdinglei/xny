...
namespace OneNET.Api.Response
{
    ...
    /// @author Philo
    /// </summary>
    public class GetSingleDeviceInfoRsp : OneNETResponse
    {
        public KeyInfo KeyInfo { get; set; }
        public SingleDeviceInfoData Data { get; set; }

        /// <summary>
        /// 查询设备信息的响应消息对应的描述, 用制定的设备ID去查看设备时响应消息
        /// </summary>
        public GetSingleDeviceInfoRsp()
        {
            KeyInfo = new KeyInfo();
            Data = new SingleDeviceInfoData();
        }
    }
    public class SingleDeviceInfoData : DeviceBasicInfo
    {
